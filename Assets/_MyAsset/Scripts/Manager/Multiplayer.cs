...
public class Multiplayer : MonoBehaviour
{
    ...
    [SerializeField] private NetworkEventFunctions _networkEventFunctions;
    private Lobby _joinedLobby;
    private float _sendHeartBeatTimer = 0;
    private readonly float SEND_HEART_BEAT_TIME = 2.5f;
    ...
    async void Start()
    {
        NetworkManager.Singleton.OnServerStarted += _networkEventFunctions.OnServerStarted;
