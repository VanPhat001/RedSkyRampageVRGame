...
namespace DemoObserver
{
	public class EventDispatcher : MonoBehaviour
	{
		...
		#region Fields
		/// Store all "listener"
		Dictionary<EEventIDs, Action<object>> _listeners = new Dictionary<EEventIDs, Action<object>>();
		#endregion
		...
		public void RegisterListener (EEventIDs eventID, Action<object> callback)
		{
			// checking params
		...
		public void PostEvent (EEventIDs eventID, object param = null)
		{
			if (!_listeners.ContainsKey(eventID))
			{
		...
		public void RemoveListener (EEventIDs eventID, Action<object> callback)
		{
			// checking params
	...
	public static class EventDispatcherExtension
	{
		...
		public static void RegisterListener (this MonoBehaviour listener, EEventIDs eventID, Action<object> callback)
		{
			EventDispatcher.Instance.RegisterListener(eventID, callback);
		}

		public static void RemoveListener (this MonoBehaviour listener, EEventIDs eventID, Action<object> callback)
		{
		...
		public static void PostEvent (this MonoBehaviour listener, EEventIDs eventID, object param)
		{
			EventDispatcher.Instance.PostEvent(eventID, param);
		}

		/// Post event with no param (param = null)
		public static void PostEvent (this MonoBehaviour sender, EEventIDs eventID)
		{
